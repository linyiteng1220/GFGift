...
public class VideoPlayerActivity extends BasePermissionActivity {
        ...
        adapter.setOnItemClickListener(new SearchListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, BaseAdapter.Data data) {
                if (data instanceof SearchListAdapter.SearchResultData) {
                    LoadingDialogManager.getInstance().showLoadingDialog(VideoPlayerActivity.this, getString(R.string.dialog_info_parsing));
            ...
            DialogManager.getInstance().showInputDialog(this, getString(R.string.dialog_title_input_tv_name), getString(R.string.button_confirm), new DialogManager.DialogInputListener() {
                ...
                public void onInputConfirm(String text) {
                    if (TextUtils.isEmpty(text)) {
                        ToastManager.showInfo(VideoPlayerActivity.this, R.string.toast_tv_name_empty);
                        return;
                    }
                    ...
                    LoadingDialogManager.getInstance().showLoadingDialog(VideoPlayerActivity.this, getString(R.string.dialog_info_searching));
    ...
    public void onVideoSearchStoreChange(VideoSearchStore.VideoSearchStoreChangeEvent event) {
        switch (event.status) {
            ...
            case Store.STATUS_RESPONSE_NULL:
                ToastManager.showInfo(VideoPlayerActivity.this, R.string.toast_parse_error);
                break;
            case Store.STATUS_RESPONSE_DATA_EXCEPTION:
                ToastManager.showInfo(VideoPlayerActivity.this, event.msg);
                break;
            case Store.STATUS_REQUEST_FAIL:
                ToastManager.showInfo(VideoPlayerActivity.this, R.string.toast_server_error);
                break;
            case Store.STATUS_NETWORK_ERROR:
                ToastManager.showInfo(VideoPlayerActivity.this, R.string.toast_network_error);
                break;
        }
    ...
    public void onVideoDownloadStoreChange(VideoDownloadStore.VideoDownloadChangeEvent event) {
        switch (event.status) {
            case Store.STATUS_RESPONSE_OK:
                startService(new Intent(getApplicationContext(), VideoDownloadService.class));
                ToastManager.showInfo(VideoPlayerActivity.this, getString(R.string.toast_start_to_download, event.name));
                break;
            case Store.STATUS_RESPONSE_NULL:
                ToastManager.showInfo(VideoPlayerActivity.this, R.string.toast_parse_error);
                break;
